...
export class AddressServices {
    ...
    async get(
        ...
        const address = await this.checkAddressMustExis(
            getRequest.contact_id,
    ...
    async update(
        ...
        let address = await this.checkAddressMustExis(
            updateRequest.contact_id,
            updateRequest.id,
        );
    ...
    async remove(
        ...
        await this.checkAddressMustExis(
            removeRequest.contact_id,
